...
const SNSModal = () => {
    ...
    return (
        <Box>
            <Button h={"220%"} borderColor={"black"} fontSize={"2xl"} color="white" as={"samp"} onClick={onOpen} bg={"teal.200"} cursor={"pointer"}>SNSに共有する</Button>
            <Modal isCentered isOpen={isOpen} onClose={onClose}>
                <ModalOverlay></ModalOverlay>
                <ModalContent>
                    <ModalHeader borderBottom={"solid"} borderColor={"gray.500"}>SNSに共有する</ModalHeader>
