            ...
            <Flex flexDirection={"column"} border="solid">
                <Flex flexDirection={"column"}>
                    <Box align={"right"}>
                        ...
                        <Text fontWeight="bold" fontSize={35}>¥{item.price}</Text>
                    </Box>
                </Flex>
                <OptionSelect color={color} size={size} count={count} setColor={setColor} setSize={setSize} setCount={setCount} cartCount={cartCount} setCartCount={setCartCount}></OptionSelect>
            </Flex>
